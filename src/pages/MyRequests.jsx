...
const MyRequests = () => {
  ...
  useEffect(() => {
    ...
    // Fetch rides where I was a passenger and are now completed
    const q = query(
      collection(db, 'rides'),
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      // Sort locally since we can't easily order by timestamp with array-contains in Firestore without index
