...
import { collection, query, where, getDocs, doc, getDoc, updateDoc, addDoc, serverTimestamp, increment } from 'firebase/firestore';
...
const PublicProfile = () => {
  ...
  // If trying to view own profile through this route, redirect to /profile
  useEffect(() => {
    if (currentUser && targetUserId === currentUser.uid) {
      navigate('/profile', { replace: true });
    }
  }, [currentUser, targetUserId, navigate]);
  ...
  if (viewedProfile === null || viewedProfile.isDeactivated || viewedProfile.isDeleted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <p className="text-zinc-400 font-medium max-w-sm mb-8">The profile you're looking for doesn't exist or is currently unavailable.</p>
    ...
    <div className="bg-[#F5F5F0] min-h-screen">
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 pb-28 md:pb-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-3xl font-black text-zinc-900 tracking-tight">Public Profile</h1>
        </div>
