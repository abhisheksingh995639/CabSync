      ...
      <div className='flex gap-5'>
        {[...Array(dots)].map((_, i) => (
          ...
          >
            ...
            >
              <div 
                className='w-full h-full rounded-full bg-gradient-to-b from-yellow-300 to-yellow-600 shadow-[0_0_15px_rgba(250,204,21,0.6)]'
                style={{
            ...
            <div 
               className='absolute bottom-0 w-10 h-3 border border-yellow-500/30 rounded-[100%] opacity-0'
               style={{
            ...
            {/* 3. REFLECTIVE SHADOW */}
            <div 
              className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-yellow-500/40 blur-sm'
              style={{
